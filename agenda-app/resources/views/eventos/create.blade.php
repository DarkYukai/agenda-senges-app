...
<form action="/eventos" method="POST">
    ...
    <div class="form-group">
        ...
        <input type="time"  name="inicio", id="inicio" value="{{old('inicio')}}" 
    ...
    <div class="form-group">
        ...
        <input type="time"  name="final", id="final" value="{{old('final')}}" 
    ...
    <!--realizado -->
    <div class="form-group">
        <input type="checkbox"  name="realizado", id="realizado" {{ old('realizado') ? 'checked' : ''}} 
    ...
    <button type="subimit" class="btn btn-primary" style="margin-top:5px;">Criar</button>
</form>
@endsection